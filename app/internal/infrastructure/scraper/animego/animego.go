...
func (a AnimeGo) GetTitle(document *goquery.Document) string {
...
func (a AnimeGo) GetStatus(document *goquery.Document) animeEnum.Status {
...
func (a AnimeGo) GetRating(document *goquery.Document) float32 {
...
func (a AnimeGo) GetEpisodes(document *goquery.Document) string {
...
func (a AnimeGo) GetGenres(document *goquery.Document) []string {
...
func (a AnimeGo) GetVoiceActing(document *goquery.Document) []string {
...
func (a AnimeGo) GetAnime(document *goquery.Document) entity.Anime {
	//TODO implement me
	panic("implement me")
}
